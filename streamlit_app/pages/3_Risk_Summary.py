...
fig = px.bar(tier_df, x="risk_category", y="claim_rate",
             text="claim_rate", labels={"risk_category": "Risk Tier", "claim_rate": "Claim Rate"}, color="risk_category", color_discrete_sequence=px.colors.sequential.PuBu_r)
...
fig2 = px.pie(dist_df, names="risk_score", values="pct_of_portfolio", color_discrete_sequence=px.colors.sequential.PuBu_r)
